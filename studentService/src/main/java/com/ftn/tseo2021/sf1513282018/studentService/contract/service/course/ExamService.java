...
public interface ExamService extends BaseService<DefaultExamDTO, Integer> {
    ...
    Page<ExamPeriodExamDTO> filterExamsByExamPeriod(int examPeriodId, Pageable pageable, ExamPeriodExamDTO filterOptions);
    
    Page<CourseExamDTO> filterExamsByCourse(int courseId, Pageable pageable, CourseExamDTO filterOptions);
